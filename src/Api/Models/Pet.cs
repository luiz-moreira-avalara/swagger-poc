...
namespace IO.Swagger.Models
{
    ...
    public partial class Pet :  IEquatable<Pet>
    {
        ...
        public Pet(long? Id = default(long?), Category Category = default(Category), string Name = default(string), List<string> PhotoUrls = default(List<string>), List<Tag> Tags = default(List<Tag>), string Status = default(string))
        {
